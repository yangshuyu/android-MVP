...
public class AutoTextHomeView extends TextSwitcher implements ViewFactory {
    ...
    public AutoTextHomeView(Context context) {
        this(context, null);
    }

    public AutoTextHomeView(Context context, AttributeSet attrs) {
        super(context, attrs);
